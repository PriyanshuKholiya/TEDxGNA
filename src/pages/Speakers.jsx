...
export default function Speakers() {
  return (
    <div className="page speakers" style={{ background: 'transparent' }}>
      <div className="white-card speakers-section" style={{ maxWidth: 1200, width: '100%', margin: '2.2rem auto', padding: '2.5rem 1.5rem', borderRadius: 12, boxShadow: '0 8px 30px rgba(0,0,0,0.06)', background: '#fff' }}>
